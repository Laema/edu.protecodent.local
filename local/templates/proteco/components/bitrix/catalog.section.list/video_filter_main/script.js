function setSectionFilter(section) {
    ...
    const sectionUrl = section.dataset.url;
    const showAll = section.closest('section').querySelector('[data-entity="section-url"]');
    ...
    if (url && containerName) {
        ...
        ra.ajax(url,'GET','',{},'html').then((response) => {
            ...
            if(container) {
                var elements = container.querySelectorAll('[data-entity="item"]');
                ...
                if(showAll && sectionUrl) {
                    showAll.setAttribute('href', sectionUrl);
                }
                if(newPagiContainer) {
                    if (pagiContainer) {
                        ...
                        mutatedContainer.parentElement.querySelector('[data-entity="pagination"]').style.display = 'grid';
                    }
