...
$MESS['SLAM_EASYFORM_FIELD_CUR_URL'] = 'URL текущей страницы';
$MESS['SLAM_EASYFORM_FIELD_CUR_URL_VAL'] = '={$GLOBALS["APPLICATION"]->GetCurDir()}';
$MESS['SLAM_EASYFORM_FIELD_CUSTOM'] = 'Получатель';
$MESS['SLAM_EASYFORM_FIELD_CUSTOM_VAL_1'] = 'Отдел по работе с клиентами';
$MESS['SLAM_EASYFORM_FIELD_CUSTOM_VAL_2'] = 'Партнерский отдел';
...
$MESS['SLAM_EASYFORM_GROUP_FIELD_VALUE_EMAIL'] = 'Email для значений';
$MESS['SLAM_EASYFORM_GROUP_FIELD_VALUE_EMAIL_VAL_1'] = 'sale@site.ru';
$MESS['SLAM_EASYFORM_GROUP_FIELD_VALUE_EMAIL_VAL_2'] = 'partners@site.ru';
